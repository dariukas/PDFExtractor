...
public class MyPDFTextStripper extends PDFStreamEngine
{

    private static final String thisClassName = MyPDFTextStripper.class.getSimpleName().toLowerCase();
    ...
    /**
     * @deprecated
     * @see MyPDFTextStripper#getText( PDDocument )
    ...
    /**
     * @deprecated
     * @see MyPDFTextStripper#writeText( PDDocument, Writer )
